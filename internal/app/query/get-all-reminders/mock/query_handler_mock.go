...
//go:generate minimock -i github.com/Roum1212/todo/internal/app/query/get-all-reminders.QueryHandler -o query_handler_mock.go -n QueryHandlerMock -p mock
...
type QueryHandlerMock struct {
	...
	funcHandleQuery          func(ctx context.Context) (ra1 []reminder_aggregate.Reminder, err error)
	funcHandleQueryOrigin    string
	inspectFuncHandleQuery   func(ctx context.Context)
...
type QueryHandlerMockHandleQueryResults struct {
	ra1 []reminder_aggregate.Reminder
	err error
}
...
func (mmHandleQuery *mQueryHandlerMockHandleQuery) Expect(ctx context.Context) *mQueryHandlerMockHandleQuery {
	...
	mmHandleQuery.defaultExpectation.params = &QueryHandlerMockHandleQueryParams{ctx}
...
func (mmHandleQuery *mQueryHandlerMockHandleQuery) Inspect(f func(ctx context.Context)) *mQueryHandlerMockHandleQuery {
...
func (mmHandleQuery *mQueryHandlerMockHandleQuery) Return(ra1 []reminder_aggregate.Reminder, err error) *QueryHandlerMock {
	if mmHandleQuery.mock.funcHandleQuery != nil {
		mmHandleQuery.mock.t.Fatalf("QueryHandlerMock.HandleQuery mock is already set by Set")
	}
	...
	mmHandleQuery.defaultExpectation.results = &QueryHandlerMockHandleQueryResults{ra1, err}
...
func (mmHandleQuery *mQueryHandlerMockHandleQuery) Set(f func(ctx context.Context) (ra1 []reminder_aggregate.Reminder, err error)) *QueryHandlerMock {
	if mmHandleQuery.defaultExpectation != nil {
...
// Then helper
func (mmHandleQuery *mQueryHandlerMockHandleQuery) When(ctx context.Context) *QueryHandlerMockHandleQueryExpectation {
	if mmHandleQuery.mock.funcHandleQuery != nil {
		mmHandleQuery.mock.t.Fatalf("QueryHandlerMock.HandleQuery mock is already set by Set")
	}
	...
	expectation := &QueryHandlerMockHandleQueryExpectation{
		...
		params:             &QueryHandlerMockHandleQueryParams{ctx},
...
func (e *QueryHandlerMockHandleQueryExpectation) Then(ra1 []reminder_aggregate.Reminder, err error) *QueryHandlerMock {
	e.results = &QueryHandlerMockHandleQueryResults{ra1, err}
	return e.mock
}
...
func (mmHandleQuery *QueryHandlerMock) HandleQuery(ctx context.Context) (ra1 []reminder_aggregate.Reminder, err error) {
	...
	if mmHandleQuery.inspectFuncHandleQuery != nil {
		mmHandleQuery.inspectFuncHandleQuery(ctx)
	}

	mm_params := QueryHandlerMockHandleQueryParams{ctx}
	...
	if mmHandleQuery.HandleQueryMock.defaultExpectation != nil {
		...
		mm_got := QueryHandlerMockHandleQueryParams{ctx}
	...
	if mmHandleQuery.funcHandleQuery != nil {
		return mmHandleQuery.funcHandleQuery(ctx)
	}
	mmHandleQuery.t.Fatalf("Unexpected call to QueryHandlerMock.HandleQuery. %v", ctx)
	return
}
