...
//go:generate minimock -i github.com/Roum1212/todo/internal/app/command/delete-reminder.CommandHandler -o command_handler_mock.go -n CommandHandlerMock -p mock
...
import (
	...
	mm_delete_reminder_command "github.com/Roum1212/todo/internal/app/command/delete-reminder"
...
type CommandHandlerMock struct {
	...
	funcHandleCommand          func(ctx context.Context, c mm_delete_reminder_command.Command) (err error)
	funcHandleCommandOrigin    string
	inspectFuncHandleCommand   func(ctx context.Context, c mm_delete_reminder_command.Command)
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) Expect(ctx context.Context, c mm_delete_reminder_command.Command) *mCommandHandlerMockHandleCommand {
	...
	mmHandleCommand.defaultExpectation.params = &CommandHandlerMockHandleCommandParams{ctx, c}
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) ExpectCParam2(c mm_delete_reminder_command.Command) *mCommandHandlerMockHandleCommand {
	...
	mmHandleCommand.defaultExpectation.paramPtrs.c = &c
	mmHandleCommand.defaultExpectation.expectationOrigins.originC = minimock.CallerInfo(1)
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) When(ctx context.Context, c mm_delete_reminder_command.Command) *CommandHandlerMockHandleCommandExpectation {
	...
	expectation := &CommandHandlerMockHandleCommandExpectation{
		...
		params:             &CommandHandlerMockHandleCommandParams{ctx, c},
...
func (mmHandleCommand *CommandHandlerMock) HandleCommand(ctx context.Context, c mm_delete_reminder_command.Command) (err error) {
	...
	if mmHandleCommand.inspectFuncHandleCommand != nil {
		mmHandleCommand.inspectFuncHandleCommand(ctx, c)
	}

	mm_params := CommandHandlerMockHandleCommandParams{ctx, c}
	...
	if mmHandleCommand.HandleCommandMock.defaultExpectation != nil {
		...
		mm_got := CommandHandlerMockHandleCommandParams{ctx, c}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.c != nil && !minimock.Equal(*mm_want_ptrs.c, mm_got.c) {
				mmHandleCommand.t.Errorf("CommandHandlerMock.HandleCommand got unexpected parameter c, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmHandleCommand.HandleCommandMock.defaultExpectation.expectationOrigins.originC, *mm_want_ptrs.c, mm_got.c, minimock.Diff(*mm_want_ptrs.c, mm_got.c))
			}
	...
	if mmHandleCommand.funcHandleCommand != nil {
		return mmHandleCommand.funcHandleCommand(ctx, c)
	}
	mmHandleCommand.t.Fatalf("Unexpected call to CommandHandlerMock.HandleCommand. %v %v", ctx, c)
	return
}
