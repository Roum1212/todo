...
//go:generate minimock -i github.com/Roum1212/todo/internal/app/command/create-reminder.CommandHandler -o command_handler_mock_test.go -n CommandHandlerMock -p create_reminder_command
...
// CommandHandlerMock implements CommandHandler
type CommandHandlerMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcHandleCommand          func(ctx context.Context, command Command) (err error)
	funcHandleCommandOrigin    string
	inspectFuncHandleCommand   func(ctx context.Context, command Command)
	afterHandleCommandCounter  uint64
	beforeHandleCommandCounter uint64
	HandleCommandMock          mCommandHandlerMockHandleCommand
}

// NewCommandHandlerMock returns a mock for CommandHandler
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) Expect(ctx context.Context, command Command) *mCommandHandlerMockHandleCommand {
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) ExpectCommandParam2(command Command) *mCommandHandlerMockHandleCommand {
	if mmHandleCommand.mock.funcHandleCommand != nil {
		mmHandleCommand.mock.t.Fatalf("CommandHandlerMock.HandleCommand mock is already set by Set")
	}
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) Inspect(f func(ctx context.Context, command Command)) *mCommandHandlerMockHandleCommand {
...
func (mmHandleCommand *mCommandHandlerMockHandleCommand) Set(f func(ctx context.Context, command Command) (err error)) *CommandHandlerMock {
	if mmHandleCommand.defaultExpectation != nil {
...
// Then helper
func (mmHandleCommand *mCommandHandlerMockHandleCommand) When(ctx context.Context, command Command) *CommandHandlerMockHandleCommandExpectation {
	if mmHandleCommand.mock.funcHandleCommand != nil {
		mmHandleCommand.mock.t.Fatalf("CommandHandlerMock.HandleCommand mock is already set by Set")
	}
...
func (mmHandleCommand *CommandHandlerMock) HandleCommand(ctx context.Context, command Command) (err error) {
