...
//go:generate minimock -i github.com/Roum1212/todo/internal/app/command/create-reminder.CommandHandler -o command_handler_mock.go -n CommandHandlerMock -p mock
