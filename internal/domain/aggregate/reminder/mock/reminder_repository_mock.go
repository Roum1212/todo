...
//go:generate minimock -i github.com/Roum1212/todo/internal/domain/aggregate/reminder.ReminderRepository -o reminder_repository_mock.go -n ReminderRepositoryMock -p mock
...
import (
	...
	mm_reminder_aggregate "github.com/Roum1212/todo/internal/domain/aggregate/reminder"
	reminder_id_model "github.com/Roum1212/todo/internal/domain/model/reminder-id"
	"github.com/gojuno/minimock/v3"
)

// ReminderRepositoryMock implements mm_reminder_aggregate.ReminderRepository
type ReminderRepositoryMock struct {
	...
	funcGetAllReminders          func(ctx context.Context) (ra1 []mm_reminder_aggregate.Reminder, err error)
	...
	funcGetReminderByID          func(ctx context.Context, reminderID reminder_id_model.ReminderID) (r1 mm_reminder_aggregate.Reminder, err error)
	...
	funcSaveReminder          func(ctx context.Context, reminder mm_reminder_aggregate.Reminder) (err error)
	funcSaveReminderOrigin    string
	inspectFuncSaveReminder   func(ctx context.Context, reminder mm_reminder_aggregate.Reminder)
	afterSaveReminderCounter  uint64
	beforeSaveReminderCounter uint64
	SaveReminderMock          mReminderRepositoryMockSaveReminder
}

// NewReminderRepositoryMock returns a mock for mm_reminder_aggregate.ReminderRepository
...
// DeleteReminder implements mm_reminder_aggregate.ReminderRepository
...
type ReminderRepositoryMockGetAllRemindersResults struct {
	ra1 []mm_reminder_aggregate.Reminder
	err error
}
...
func (mmGetAllReminders *mReminderRepositoryMockGetAllReminders) Return(ra1 []mm_reminder_aggregate.Reminder, err error) *ReminderRepositoryMock {
	if mmGetAllReminders.mock.funcGetAllReminders != nil {
		mmGetAllReminders.mock.t.Fatalf("ReminderRepositoryMock.GetAllReminders mock is already set by Set")
	}
...
func (mmGetAllReminders *mReminderRepositoryMockGetAllReminders) Set(f func(ctx context.Context) (ra1 []mm_reminder_aggregate.Reminder, err error)) *ReminderRepositoryMock {
	if mmGetAllReminders.defaultExpectation != nil {
...
func (e *ReminderRepositoryMockGetAllRemindersExpectation) Then(ra1 []mm_reminder_aggregate.Reminder, err error) *ReminderRepositoryMock {
...
// GetAllReminders implements mm_reminder_aggregate.ReminderRepository
func (mmGetAllReminders *ReminderRepositoryMock) GetAllReminders(ctx context.Context) (ra1 []mm_reminder_aggregate.Reminder, err error) {
...
type ReminderRepositoryMockGetReminderByIDResults struct {
	r1  mm_reminder_aggregate.Reminder
	err error
}
...
func (mmGetReminderByID *mReminderRepositoryMockGetReminderByID) Return(r1 mm_reminder_aggregate.Reminder, err error) *ReminderRepositoryMock {
	if mmGetReminderByID.mock.funcGetReminderByID != nil {
		mmGetReminderByID.mock.t.Fatalf("ReminderRepositoryMock.GetReminderByID mock is already set by Set")
	}
...
func (mmGetReminderByID *mReminderRepositoryMockGetReminderByID) Set(f func(ctx context.Context, reminderID reminder_id_model.ReminderID) (r1 mm_reminder_aggregate.Reminder, err error)) *ReminderRepositoryMock {
	if mmGetReminderByID.defaultExpectation != nil {
...
func (e *ReminderRepositoryMockGetReminderByIDExpectation) Then(r1 mm_reminder_aggregate.Reminder, err error) *ReminderRepositoryMock {
...
// GetReminderByID implements mm_reminder_aggregate.ReminderRepository
func (mmGetReminderByID *ReminderRepositoryMock) GetReminderByID(ctx context.Context, reminderID reminder_id_model.ReminderID) (r1 mm_reminder_aggregate.Reminder, err error) {
...
type ReminderRepositoryMockSaveReminderParams struct {
	ctx      context.Context
	reminder mm_reminder_aggregate.Reminder
}
...
func (mmSaveReminder *mReminderRepositoryMockSaveReminder) Expect(ctx context.Context, reminder mm_reminder_aggregate.Reminder) *mReminderRepositoryMockSaveReminder {
...
func (mmSaveReminder *mReminderRepositoryMockSaveReminder) ExpectReminderParam2(reminder mm_reminder_aggregate.Reminder) *mReminderRepositoryMockSaveReminder {
	if mmSaveReminder.mock.funcSaveReminder != nil {
		mmSaveReminder.mock.t.Fatalf("ReminderRepositoryMock.SaveReminder mock is already set by Set")
	}
...
func (mmSaveReminder *mReminderRepositoryMockSaveReminder) Inspect(f func(ctx context.Context, reminder mm_reminder_aggregate.Reminder)) *mReminderRepositoryMockSaveReminder {
...
func (mmSaveReminder *mReminderRepositoryMockSaveReminder) Set(f func(ctx context.Context, reminder mm_reminder_aggregate.Reminder) (err error)) *ReminderRepositoryMock {
	if mmSaveReminder.defaultExpectation != nil {
...
// Then helper
func (mmSaveReminder *mReminderRepositoryMockSaveReminder) When(ctx context.Context, reminder mm_reminder_aggregate.Reminder) *ReminderRepositoryMockSaveReminderExpectation {
	if mmSaveReminder.mock.funcSaveReminder != nil {
		mmSaveReminder.mock.t.Fatalf("ReminderRepositoryMock.SaveReminder mock is already set by Set")
	}
...
// SaveReminder implements mm_reminder_aggregate.ReminderRepository
func (mmSaveReminder *ReminderRepositoryMock) SaveReminder(ctx context.Context, reminder mm_reminder_aggregate.Reminder) (err error) {
